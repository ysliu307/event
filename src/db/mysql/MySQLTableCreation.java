	...
	public static void main(String[] args) {
		try {
			...
			sql = "CREATE TABLE items" + "(item_id VARCHAR(255) NOT NULL, "
					+ "name VARCHAR(255), city VARCHAR(255), state VARCHAR(255), country VARCHAR(255), "
					+ "zipcode VARCHAR(255), " + "rating FLOAT," + "address VARCHAR(255), " + "latitude FLOAT, "
					+ "longitude FLOAT, " + "description VARCHAR(255), " + "snippet VARCHAR(255), " + "snippet_url VARCHAR(255), " + "image_url VARCHAR(255), " +
					...
					+ "user_id VARCHAR(255) NOT NULL, " + "item_id VARCHAR(255) NOT NULL, " + "last_favor_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, " + "PRIMARY KEY (history_id), "
